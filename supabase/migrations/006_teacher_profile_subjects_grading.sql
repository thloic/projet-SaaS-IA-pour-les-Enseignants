-- Permet plusieurs matières tout en conservant `subject` pour les écrans et
-- intégrations existants. Répare aussi les anciens schémas où grading_system
-- pouvait avoir un type ou une contrainte obsolète.
